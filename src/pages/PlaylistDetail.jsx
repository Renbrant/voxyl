      ...
      <div className="px-4 mt-4">
        <div className="flex items-center justify-between mb-3">
          <h2 className="font-semibold text-foreground flex items-center gap-2">
            ...
            {backgroundSyncSource === 'local' && episodes.length > 0 && <span className="text-xs px-2 py-1 rounded-full bg-accent/10 text-accent font-medium">📡 Cache</span>}
            {!loadingEps && backgroundSyncSource === 'rss' && episodes.length > 0 && <span className="text-xs px-2 py-1 rounded-full bg-primary/10 text-primary font-medium">✓ Atualizado</span>}
          </h2>
          {episodes.length > 0 && (
            <button
              onClick={() => {
